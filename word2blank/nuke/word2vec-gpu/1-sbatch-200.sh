...
./word2vec -train ../word2vec/text8 -output models/size=200-iter=15 -cbow 0 -size 200 \
    -window 8 -negative 35 -hs 0 -sample 1e-4 -threads 1 -binary 1 -iter 30 \
    -alpha 0.025
