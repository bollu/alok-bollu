...
./compute-accuracy-topn ${MODELPATH}/text8-size=200  < questions-words.txt > fuzzy-size=200-accuracy.txt
./compute-accuracy-topn ${MODELPATH}/text8-size=100  < questions-words.txt > fuzzy-size=100-accuracy.txt
./compute-accuracy-topn ${MODELPATH}/text8-size=50  < questions-words.txt > fuzzy-size=50-accuracy.txt
./compute-accuracy-topn ${MODELPATH}/text8-size=20  < questions-words.txt > fuzzy-size=20-accuracy.txt
./compute-accuracy-topn ${MODELPATH}/text8-size=10  < questions-words.txt > fuzzy-size=10-accuracy.txt
