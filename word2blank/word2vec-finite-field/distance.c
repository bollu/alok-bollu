...
void cosine() {
    ...
    for (c = 0; c < words; c++) {
        ...
        /*
        printf("%s: ", vocab + bi[0] * max_w);
        printf(" |");
        for (a = 0; a < size; a++) {
            printf("%d ", vec[a + c * size]);
        }
        printf(" |\n");

        printf("%s: ", vocab + c * max_w);
        printf(" |");
        for (a = 0; a < size; a++) {
            printf("%d ", M[a + c * size]);
        }
        ...
        */
        ...
        for (a = 0; a < size; a++) {
            //   printf("%d = %d + %d * %d\n",
            //          (dist + vec[a] * M[a + c * size]) % FFCOEFF, dist,
            //          vec[a], M[a + c * size]);
...
int main(int argc, char **argv) {
    ...
    M = (ff *)malloc((long long)words * (long long)size * sizeof(ff));
    if (M == NULL) {
    ...
    for (b = 0; b < words; b++) {
        ...
        printf("|");
        for (a = 0; a < size; a++) printf("%ld ", M[a + b * size]);
        printf("|\n");
        // len = 0;
